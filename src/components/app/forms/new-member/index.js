    ...
    <>
      ...
      <Slide direction="up" in={regDone} mountOnEnter unmountOnExit>
        <Grid container spacing={2} className="justify-content-evenly">
          ...
          >
            <Grid item xs={12} sm={8} md={6} lg={6}>
              <Typography variant="h4" className="text-center">
                मासिक दान राशि{" "}
                <VolunteerActivismIcon sx={{ fontSize: 40, mt: "-12px" }} />
              </Typography>
            </Grid>
            <Grid
              item
            ...
            >
              <FormControl sx={{ alignContent: "center" }} variant="standard">
                <Input
                  sx={{ fontSize: "1.7rem", color: "darkgreen" }}
                  type="number"
          ...
          <Grid item xs={12}>
            {Number(memberForm.donate_amount) >= 60 && (
              <Typography variant="body1" className="mt-2">
                ₹
                {memberForm.donate_amount < 100
                  ? 100
                  : memberForm.donate_amount}{" "}
                अभी भुकतान करें और प्रति माह ₹{memberForm.donate_amount} दान
                करें{" "}
              </Typography>
            )}
            ...
            <CheckoutButton
              ...
              member={memberForm}
              amount={memberForm.donate_amount}
