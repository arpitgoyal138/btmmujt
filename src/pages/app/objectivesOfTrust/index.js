      ...
      <div className="row">
        <div className="col-sm-12 m-auto">
          <ul className="list-group">
            ...
            <li className="list-group-item list-group-item-success">
              ८. शिक्षा स्थान व शिक्षा के लिए ट्रस्ट के पदाधिकारी ट्रस्ट के बजट
              के हिसाब से अपनी सहमति से मदद करेंगे
            </li>
            <li className="list-group-item list-group-item-success">
              ९. ट्रस्ट अपने सभी पदाधिकारी व सदस्यों की आपस में मदद करेंगे | इस
              योजना का लाभ केवल ट्रस्ट में जुड़ने पर ही सदस्यों व पदाधिकारियों को
              मिलेगा
            </li>
            <li className="list-group-item list-group-item-success">
...
export default ObjectivesOfTrust;
